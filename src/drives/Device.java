...
/**
 * Device simulate a data storage device, in this case a SSD. Such device is
 * only able to read/write a full sector of the memory at a time.
 */
public class Device implements IDevice {
	 ...
	 * 
	 * @return the number of sector stored in the mounted drive, 0 if no mounted
	 *         drive
	 */
	@Override
