...
public interface IFileSystem {
     ...
     * @param mode     if 'r' open the file in read-only mode else if 'w' open the
     *                 file in write mode (erase its current content). else if 'a'
     *                 open the file in append mode (start writing at the end of the
     *                 file)
     *
     *                 For both 'r' and 'w', the file descriptor is set at the
     *                 beginning of the file. For 'a', the file descriptor is set at
     *                 the end of the file.
     */
